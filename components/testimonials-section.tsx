...
export function TestimonialsSection() {
  ...
  return (
    <section id="testimonios" className="py-16 md:py-24 bg-gradient-to-br from-[#1e40af] to-[#1e3a8a] relative overflow-hidden">
      {/* Decorative elements */}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-white/20">
            <div className="flex flex-col items-center text-center">
              {/* Avatar placeholder */}
              <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#d4af37] to-[#c9a030] flex items-center justify-center mb-6 border-4 border-[#d4af37]/30">
              ...
              {/* Type Badge */}
              <span className="inline-block bg-[#d4af37] text-[#1e40af] px-4 py-1 rounded-full text-sm font-semibold mb-6">
          ...
          <div className="flex justify-center items-center gap-4 mt-8">
            <Button
              ...
              className="w-12 h-12 rounded-full bg-white/10 hover:bg-[#d4af37] text-white border border-white/20 hover:border-[#d4af37]"
            >
